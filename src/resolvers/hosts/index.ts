...
const RESOLVERS: HostFilterResolver[] = [
    ...
    optional((filter: HostFilter) => filter.fqdn, _.partial(filterString, 'canonical_facts.provider_type')),
    optional((filter: HostFilter) => filter.fqdn, _.partial(filterString, 'canonical_facts.provider_id')),
